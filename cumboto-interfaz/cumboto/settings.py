"""
Django settings for cumboto project.
...
## Directorio en donde se encuentran las plantillas del modulo servicios
SERVICIOS_TEMPLATES = os.path.join(BASE_DIR, "servicios/templates")
